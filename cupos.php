<?php
	...
	$sql = "
		...
		WHERE 
			...
			servicio_id.meta_key   	= '_booking_product_id' 	AND  servicio_id.meta_value = '149490' AND
	...
	//$db->query("UPDATE cupos SET cupos = 0 WHERE cupos > 0");
	$db->query("UPDATE cupos SET cupos = 0 WHERE servicio = '149490'");
