...
<div style='font-family: Verdana; width: 100%'>
    ...
    '>
        ...
        <div style='
            ...
            text-align: left; 
        '>
            La cita <strong style="color: #6B169B; text-transform: capitalize;">#[CONSULTA_ID]</strong> ha sido <strong style="color: #6B169B; text-transform: capitalize;">CANCELADA</strong> por el veterinario.
        </div>
...
<div style='text-align: center;'>
    <img style='width: 100%; margin: 35px 0px 20px;' src='[KV_URL_IMGS]/CONSULTA/CANCELACION/INFO.png' />
</div>
