...
<!-- Style -->
<link rel="stylesheet" type="text/css" href="<?php echo $ruta; ?>/monitor/reportes/cuidadores/css/cuidadores.css">
<script type="text/javascript" src="<?php echo $ruta; ?>/monitor/reportes/cuidadores/js/cuidadores.js"></script>
