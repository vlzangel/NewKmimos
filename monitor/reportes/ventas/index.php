...
<!-- Style -->
<link rel="stylesheet" type="text/css" href="<?php echo $ruta; ?>/monitor/reportes/ventas/css/ventas.css">
...
<!-- Scripts -->
<script type="text/javascript" src="<?php echo $ruta; ?>/monitor/reportes/ventas/js/ventas.js"></script>
