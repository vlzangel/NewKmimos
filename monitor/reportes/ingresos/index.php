...
<!-- Style -->
<link rel="stylesheet" type="text/css" href="<?php echo $ruta; ?>/monitor/reportes/ingresos/css/ingresos.css">
...
<div class="col-sm-12">
    ...
    <header class="row" style="padding:15px 0px 0px 0px;">
        <div class="col-md-6">
            <h2 style="margin-top:0px;margin-bottom:10px;">Resumen de ingresos</h2>
        </div>
        <div class="col-md-6">
...
<!-- Scripts -->
<script type="text/javascript" src="<?php echo $ruta; ?>/monitor/reportes/ingresos/js/ingresos.js"></script>
