...
<!-- Style -->
<link rel="stylesheet" type="text/css" href="<?php echo $ruta; ?>/monitor/reportes/cliente_costo/css/cliente_costo.css">
...
<!-- Scripts -->
<script type="text/javascript" src="<?php echo $ruta; ?>/monitor/reportes/cliente_costo/js/cliente_costo.js"></script>
