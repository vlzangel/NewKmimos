...
include('partes/blog/header.php');
?>
<style>
    /*WIEWED*/
...
<section id="blog_viewed">
    <div class="contain">
        ...
        <div class="section viewed">
            <?php
                include('partes/blog/process/viewed.php');
            ?>
...
<section id="last">
    <div class="group contain">
        ...
        <div class="section news">
            ...
            <?php
                include('partes/blog/process/news.php');
            ?>
        </div>
    </div>
</section>
...
<section id="featured">
    ...
    <div class="title info">
        ...
        <?php
            include(getTema().'/partes/blog/frontend/featured.php');
        ?>
</section>
...
<section id="products">
    <?php
    include('partes/blog/frontend/products.php');
    ?>
</section>
...
<?php
    include('partes/blog/footer.php');
?>
