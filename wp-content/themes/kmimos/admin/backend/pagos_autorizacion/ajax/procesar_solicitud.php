    ...
    foreach ($list as $item) {
        ...
        //if( $solicitud->admin_id != $user_id ){
            ...
            // Autorizar registro
                ...
                $db->query("UPDATE cuidadores_pagos SET autorizado = '".serialize($autorizaciones)."' WHERE id=" . $item['ID'] );
            ...
            // Procesar pago            
                ...
                //  Actualizar registro
                    $db->query("UPDATE cuidadores_pagos SET estatus='".$estatus."', observaciones='".$observaciones."', openpay_id='".$openpay_id."' WHERE id = " . $item['ID'] );
                }
