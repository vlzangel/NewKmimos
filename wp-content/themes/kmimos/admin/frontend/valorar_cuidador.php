     ...
     ".
       ...
       $post_id = vlz_get_page();
        ...
        if($_POST['funcion'] =='rate'){
            ...
            $CONTENIDO.="<h1>Valoración Enviada</h1>
             <p>Gracias por regalarnos tu evaluación, es sumamente importante para Kmimos y todos los que somos parte de esta comunidad saber lo que opinas del servicio que has recibido.</p>
