...
var url_app = {
    ...
    "android_kmimos" : RAIZ+"al/?t=android_kmimos&utm_source=WebID-Kmimos-App-Banner-Playstore&utm_medium=WebBanner-Landing_Kmimos&utm_campaign=Banner_Invitacion-Descarga_la_app_Kmimos_Playstore&utm_term=Descargar%20_para_Playstore-ANDROID&utm_content=Banner_descarga_ANDROID-Kmimos_app",
    "android_wlabel" : RAIZ+"al/?t=android_wlabel&utm_source=WebID-Kmimos-App-Banner-WL_PETCO-Playstore&utm_medium=WebBanner-Landing_Kmimos_WL-PETCO&utm_campaign=Banner_Invitacion-Descarga_la_app_Kmimos_Playstore&utm_term=Descargar%20_para_Playstore-ANDROID&utm_content=Banner_descarga_ANDROID-Kmimos_app-PETCO",
};
...
jQuery( document ).ready(function() {
    ...
    jQuery("#otro").on('change', function(e){
        ...
        if( jQuery(this).prop('checked') ){
            ...
            jQuery("#input_otro").attr('disabled', true);
        }
    });
