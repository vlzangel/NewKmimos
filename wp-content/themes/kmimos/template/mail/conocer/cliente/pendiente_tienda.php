...
<div style='font-family: Verdana; width: 600px'>
    ...
    '>
        ...
        <div style='
            ...
            text-align: left;
        '>
            ¡Hola <strong>[name_cliente]</strong>!
        </div>  
        ...
        <div style='
            ...
            text-align: left; 
        '>
           	Recibimos tu solicitud de compra de <strong>tres (3)</strong> solicitudes para conocer a cuidadores kmimos.
        </div>
        ...
        <div style='
            ...
            padding-bottom: 30px;
        '>
            Has seleccionado como método de pago:
        </div>
        ...
        <div style='
            ...
            padding-bottom: 30px;
        '>
            a  continuación encontrarás los pasos a seguir para poder completar tu compra.
        </div>
    ...
    '>
        ...
        <div style='
            ...
            padding: 20px 0px; 
        '>
            Código de pago: <strong>[CODIGO]</strong>
        </div>
