...
<div style='padding: 0px;'>
	...
	<div style='font-size: 14px; line-height: 1.07; letter-spacing: 0.3px; color: #000000;'>
	    ...
	    <div style='font-family: Arial; font-size: 14px; line-height: 1.07; letter-spacing: 0.3px; color: #000000; padding: 26px 0px 30px;'>
	    	En caso de que alguna de estas opciones no se adecúe a tus necesidades, por favor ingresa a <a href='#' style='text-decoration: none; color: #1163d0; font-weight: 600;'>Kmimos <?php echo get_region('pais'); ?></a> en donde podrás encontrar cientos de cuidadores que seguro te encantarán.
	    </div>
