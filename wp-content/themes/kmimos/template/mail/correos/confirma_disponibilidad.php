...
<div style='font-family: Verdana; width: 600px'>
    ...
    '>
        ...
        <div style='font-size: 19px; padding-bottom: 30px; text-align: left;  color: #940d99;'>
    ...
    <div style='
        line-height: 1.3; letter-spacing: 0.3px; color: #000000;
        padding: 30px 30px 50px; font-size: 14px; 
    '>
    ...
    <img style="width: 100%;" src="[URL_IMGS]/correos/confirmacion_disponibilidad/Banner.jpg" />
