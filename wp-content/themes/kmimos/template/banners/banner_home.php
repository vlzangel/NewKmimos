...
<div>
	<div id="PageSubscribe_NEW">
		...
		<div class="section_1">
			...
			<p class="p_1">&#161;solo déjanos tu correo!</p>
			<p class="p_2">&#161;SUSCR&Iacute;BETE! y recibe el Newsletter con nuestras PROMOCIONES, TIPS DE CUIDADOS PARA MASCOTAS, etc.!</p>
		</div>
		<div class="section_2">
			<?= $FORM ?>
		...
		<div class="img_banner_pc" style="background-image: url(<?= $HOME; ?>/recursos/img/BANNERS/Popup_Home/PC/Happy-dog.jpg)"></div>
	</div>
</div>