...
/*        $sql = "SELECT ID FROM wp_posts WHERE post_author = '{$user_id}' AND post_type='product'";
        ...
        foreach ($servicios as $servicio) {
            ...
            $rangos = $db->get_var(" SELECT meta_value FROM wp_postmeta WHERE post_id = '{$servicio->ID}' AND meta_key = '_wc_booking_availability' ");
            $rangos = unserialize($rangos);
            ...
            $autor = $db->get_var("SELECT post_author FROM wp_posts WHERE ID = '{$servicio->ID}' ");
