...
class CreateOrder {
	...
	private $base_url;
  	...
  	public function create($base_url, $data=[], $echo=false) {
  		extract($data);
  		$resultado='';
  	...
  	private function buildRequestBody( $data ){	
        ...
        $return = array(
            ...
            'application_context' => array(
                'return_url' => $this->base_url.'/reservar/validar-pago/?p=paypal&t=return',
                'cancel_url' => $this->base_url.'/reservar/validar-pago/?p=paypal&t=cancel',
            ),
