	    ...
	    function construir_botones($botones){
	    	...
	    	foreach ($botones as $boton => $accion) {
	    		switch ($boton) {
    				...
    				break;
	    			case 'confirmar':
	    				$respuesta .= '<a data-accion="'.get_home_url()."/wp-content/plugins/kmimos/order.php?s=1&o=".$accion.'" class="vlz_accion vlz_confirmar"> <i class="fa fa-check" aria-hidden="true"></i> Confirmar </a>';
    				break;
	    			case 'cancelar':
