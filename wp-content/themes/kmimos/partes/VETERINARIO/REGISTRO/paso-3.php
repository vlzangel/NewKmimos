<div>
	...
	<input type="text" name="kv_titulo" valid="required" class="validar" />
</div>

<div>
	<label>Cedula Profesional</label>
	<input type="text" name="kv_cedula" valid="required" class="validar" />
</div>
...
<div>
	...
	<textarea name="kv_servicio_social" valid="required" class="validar"></textarea>
</div>
...
<div class="kv_red_otra_especialidad">
	...
	<div>
		<label>Cedula de Especialidad</label>
		<input type="text" name="kv_red_otra_cedula" />
	</div>
	<div>
		<label>Universidad</label>
		<input type="text" name="kv_red_otra_universidad" />
	</div>
</div>