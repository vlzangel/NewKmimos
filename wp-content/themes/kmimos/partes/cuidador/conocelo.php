			...
			<div class="popup-iniciar-sesion-2" style="display: none;">
				...
				<div>
					...
					<div>
						...
						<label> Para cualquier duda y/o comentario puedes contactar al Staff Kmimos a los teléfonos '.get_region('telefono_atencion').' y WhatsApp '.get_region('whatsapp').', o al correo '.get_region('email').'</label>
					</div>
				</div>
				<br>
				<br>
