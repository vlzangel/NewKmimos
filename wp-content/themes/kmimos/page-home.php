    ...
    */
    ...
    $HTML .= '
		...
		if( time() > strtotime("2018-11-16 00:00:00") ){
			...
			$HTML .= '
				<a target="_blanck" href="'.get_home_url().'/redireccion/?utm_source=homepage&utm_medium=banner&utm_campaign=nomadas_kmimos&url=https://www.nomadas.life/?publicmap=kmimos" style="display: block;">
