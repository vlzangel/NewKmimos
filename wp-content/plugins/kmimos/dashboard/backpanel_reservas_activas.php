<?php  
	...
	// Reservas 
	require_once('core/ControllerReservasActivas.php');
	...
	$actualizar = true;
	$razas = get_razas();
	$reservas = getReservas($_desde, $_desde);
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="row text-right"> 
					<div class="col-sm-12">
				    	<form class="form-inline" action="<?php echo get_home_url(); ?>/wp-admin/admin.php?page=bp_reservas_activas" method="POST">
						  	<label>Filtrar:</label>
						  	<div class="form-group">
						    	<div class="input-group">
						      		<div class="input-group-addon">Hoy</div>
