<?php global $wpdb;
// Reservas 
require_once('core/ControllerReservasLimitDate.php');
			...
			<table id="tblReservas" class="table table-striped table-bordered dt-responsive table-hover table-responsive nowrap datatable-buttons" 
			  ...
			  <tbody>
			  	...
			  	<?php foreach( $reservas as $reserva ){ ?>
					...
					$countReservas = getReservasByCuidador( $reserva->cuidador_id );
				    	...
				    	<th class="text-center"><?php echo count($countReservas); ?></th>
