        ...
        function kmimos_active_petsitter($post, $params) {
            ...
            if( $cuidador->hospedaje_desde > 0 ){
                if( $post->post_status == 'pending' ){
                    $link = "<a class='vlz_activar' href='".getTema()."/procesos/admin/activar_cuidadores.php?p=".$post->ID."&a=1&u=".$post->post_author."'>Activar Cuidador</a>";
                }else{
                    $link = "<a class='vlz_desactivar' href='".getTema()."/procesos/admin/activar_cuidadores.php?p=".$post->ID."&a=0&u=".$post->post_author."'>Desactivar Cuidador</a>";
                }
            }else{
