			  						...
			  						if( $actualizar ){
								  		...
								  		$total_remanente=0;
											...
											*/
											...
											$data = [
												...
												$metodo_pago,
												$tipo_pago,
												number_format( $meta_reserva['_booking_cost'], 2, '.', ','),
												number_format( $meta_Pedido['_order_total'], 2, '.', ','),
												number_format( $meta_Pedido['_wc_deposits_remaining'], 2, '.', ','),

												$cupones[ 'info' ]['saldo'],

												implode(', ', $cupones[ 'info' ]['promo']['kmimos']['cupones']),
												num_for( $cupones[ 'info' ]['promo']['kmimos']['total'] ),

												implode(', ', $cupones[ 'info' ]['promo']['cuidador']['cupones']),
												'',
												'',
										...
										foreach ($reservas as $key => $value) {
											...
											$data = [
												...
												$value->forma_de_pago,
												$value->tipo_de_pago,
												number_format( $value->total_a_pagar, 2, '.', ',' ),
												number_format( $value->monto_pagado, 2, '.', ',' ),
												number_format( $value->monto_remanente, 2, '.', ',' ),
												$cupones['kmimos'],
												$cupones['cuidador'],
												$cupones['total'],
												$value->pedido,
