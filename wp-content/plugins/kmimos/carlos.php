		                ...
		                <div class="vlz_tabla">
		                	...
		                	<div class="vlz_tabla_superior">
			                	...
			                	<div class="vlz_tabla_cuidador vlz_botones vlz_celda boton_interno">
			                		<span class="cancelar"><i class="fa fa-trash-o" aria-hidden="true"></i></span>
			                		<span class="ver_reserva_init">Ver Reserva</span>
			                	</div>
		                	...
		                	<div class="vlz_tabla_cuidador vlz_botones vlz_celda boton_fuera">
		                		<span class="ver_reserva_init_fuera">Ver Reserva</span>
		                	</div>
		                	...
		                	<div class="vlz_tabla_inferior">
		                		...
		                		<div class="desglose_reserva">
			                		...
			                		<div class="item_desglose vlz_bold">
			                			<div style="color: #6b1c9b;" >Monto Restatnte a Pagar en EFECTIVO al cuidador</div>
			                			<span style="color: #6b1c9b;">$809,25</span>
			                		</div>
		                		...
		                		<div class="ver_reserva_botones">
			                		...
			                		<span class="cancelar"> <i class="fa fa-info" aria-hidden="true"></i> Ver</span>
			                		<span class="cancelar"> <i class="fa fa-trash-o" aria-hidden="true"></i> Cancelar</span>
			                		<span class="cancelar"> <i class="fa fa-check" aria-hidden="true"></i> Confirmar</span>
			                		<span class="pdf"> <i class="fa fa-download" aria-hidden="true"></i> Descargar comprobante de pago</span>
